...
wv.date.timeline.pick = wv.date.timeline.pick || function(models, config, ui) {
    ...
    var animdrag = function() {
        ...
        if(tempPickTipDate.valueOf() < today.valueOf()) {
            ...
            d3.select(this).attr("transform", "translate(" + (tempPickOffset - animDragOffset) + " 3)");//20
            updateChanges(tempPickTipDate);
    ...
    self.updateAnimPickers = function(date) {
        ...
        var xVal = (tl.x(date) - width/2) + ANIM_OFFSET;//datepicker ani
        return "translate(" + xVal + " 3)";//"20"
    };
    ...
    var animPicks = function() {
        ...
        tl.animPick1.append("svg:path")// styling for AnimPicks Animation
            .attr("id", "fromPick")
            .attr("d", "M13.5,55.5c0,2.209-1.791,4-4,4H4c-2.209,0-4-1.791-4-4V4c0-2.209,1.791-4,4-4h5.5c2.209,0,4,1.791,4,4V55.5z")
            .attr("style","fill:rgb(158,158,158)");//0 255 0

        tl.animPick2.append("svg:path")
            .attr("id", "toPick")
            .attr("d", "M13.5,55.5c0,2.209-1.791,4-4,4H4c-2.209,0-4-1.791-4-4V4c0-2.209,1.791-4,4-4h5.5c2.209,0,4,1.791,4,4V55.5z")//"M0 0 L40 0 L20 40 Z"
            .attr("style","fill:rgb(104,122,168);");
